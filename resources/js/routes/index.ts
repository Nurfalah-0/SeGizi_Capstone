 ...
 * @route '/report-bug'
 */
export const reportBug = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: reportBug.url(options),
    method: 'get',
})

reportBug.definition = {
    methods: ["get","head"],
    url: '/report-bug',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/report-bug'
 */
reportBug.url = (options?: RouteQueryOptions) => {
    return reportBug.definition.url + queryParams(options)
}
 ...
 * @route '/report-bug'
 */
reportBug.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: reportBug.url(options),
    method: 'get',
})
/**
 ...
 * @route '/report-bug'
 */
reportBug.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: reportBug.url(options),
    method: 'head',
})
 ...
 * @route '/report-bug'
 */
    const reportBugForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: reportBug.url(options),
        method: 'get',
    })
 ...
 * @route '/report-bug'
 */
        reportBugForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: reportBug.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/report-bug'
 */
        reportBugForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: reportBug.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
